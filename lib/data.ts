...
const products: IProductInput[] = [
  {
    ...
    slug: convertToSlug("Nike Mens Slim-fit Long-Sleeve T-Shirt"),
    category: "T-Shirts",
  ...
  },
  {
    ...
    slug: convertToSlug("Jerzees Long-Sleeve Heavyweight Blend T-Shirt"),
    category: "T-Shirts",
    images: [
      "/images/p12-1.jpg",
      "/images/p12-2.jpg",
  ...
  },
  {
    ...
    slug: convertToSlug("Jerzees Men Long-Sleeve T-Shirt"),
    category: "T-Shirts",
    brand: "Jerzees",
  ...
  },
  {
    ...
    slug: convertToSlug("Hanes Mens Long Sleeve Beefy Henley Shirt"),
    category: "T-Shirts",
    brand: "Jerzees",
  ...
  // Jeans
  {
    ...
    slug: convertToSlug("Silver Jeans Co. Mens Jace Slim Fit Bootcut Jeans"),
    category: "Jeans",
  ...
  },
  {
    ...
    slug: convertToSlug("Essentials Mens Straight-Fit Stretch Jean"),
    category: "Jeans",
    brand: "Essentials",
  ...
  },
  {
    ...
    slug: convertToSlug("Dickies Mens Relaxed Fit Carpenter Jean"),
    category: "Jeans",
    brand: "Dickies",
  ...
  // Watches
  {
    ...
    slug: convertToSlug("Seiko Men's Analogue Watch with Black Dial"),
  ...
  },
  {
    ...
    slug: convertToSlug("Fossil Men's Machine Stainless Steel Quartz Watch"),
    category: "Wrist Watches",
    brand: "Fossil",
  ...
  },
  {
    ...
    slug: convertToSlug("ASICS Men's GT-2000 13 Running Shoes"),
    category: "Shoes",
    brand: "ASICS",
...
const data: Data = {
  ...
  //       name: 'OurInterior',
  //       description:
  //         'OurInterior is a sample Ecommerce website built with Next.js, Tailwind CSS, and MongoDB.',
